# Contributing to rbranding

This outlines how to propose a change to rbranding.
...
- We use [roxygen2](https://cran.r-project.org/package=roxygen2) with
  ...
  for documentation.  
- We use [tinytest](https://cran.r-project.org/package=tinytest).
  Generally, contributions must have test cases included before we will
  accept them.
...
Conduct](https://epiforesite.github.io/rbranding/CODE_OF_CONDUCT.md). By
