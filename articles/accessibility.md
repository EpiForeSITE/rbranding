...
This is a practical guide to **designing and implementing accessible
dashboards using R**. Ensuring the accessibility of dashboards benefits
everyone. It not only allows people with diverse abilities to access and
interpret data, but also improves overall usability.
...
- [WAVE Browser Extension](https://wave.webaim.org/extension/): Adds an
  on‑page overlay that visually marks accessibility errors, alerts, and
  structural cues for quick review.
- [WebAIM Contrast
  Checker](https://webaim.org/resources/contrastchecker/): Tests any
  foreground‑background color pair to confirm it meets WCAG AA/AAA
  contrast ratios.

In addition to automated tools, always perform manual checks with a
screen reader. Popular options include **VoiceOver** (macOS/iOS),
**NVDA** (Windows), and **JAWS** (Windows).

## Accessiblity Guidelines Cheatsheet

We created a cheatsheet for the above accessiblity guidelines. You may
download the cheatsheet as a
[PDF](https://github.com/EpiForeSITE/rbranding/blob/main/resources/cheatsheets/cheatsheet-accessibility-guidelines.pdf)
or
[SVG](https://github.com/EpiForeSITE/rbranding/blob/main/resources/cheatsheets/cheatsheet-accessibility-guidelines.svg)
