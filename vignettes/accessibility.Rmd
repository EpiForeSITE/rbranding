...
## Accessiblity Guildelines Cheatsheet

Download the cheatsheet below as [PDF](https://github.com/EpiForeSITE/branding-package/blob/main/vignettes/accessibility_files/cheatsheet-accessibility-guidelines.pdf) or [SVG](https://github.com/EpiForeSITE/branding-package/blob/main/vignettes/accessibility_files/cheatsheet-accessibility-guidelines.svg)

```{r, echo = FALSE}
knitr::include_graphics("accessibility_files/cheatsheet-accessibility-guidelines.svg")
```
