...
### `qwebsite`: A Simple Quarto Website Template
...
Provides a Shiny app template for visualizing wastewater data, including interactive plots and data tables. This example demonstrates how to integrate branding with [`linkeR` package](https://CRAN.R-project.org/package=linkeR).
